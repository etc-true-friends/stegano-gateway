...
def main():
    ...
    parser.add_argument("--percentile_min", type=float, default=45.0)
    parser.add_argument("--percentile_max", type=float, default=80.0)
    ...
    for idx, path in enumerate(images):
        try:
            ...
            percentile = float(rng.uniform(args.percentile_min, args.percentile_max))
            rgb = load_rgb(path, args.size)
            stego = embed_texture_adaptive_lsb(rgb, payload_ratio, percentile, args.channel, args.seed + idx)
